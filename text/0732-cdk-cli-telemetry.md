...
| Error Messages     | The error message returned, if an error occurs. Free form text redacted                                                                                    | Capturing the error message will help us aggregate data on which errors are encountered at a greater rate, as well as help us debug what went wrong in individual use cases.                                                                         |
| Error Stack Trace  | The stack trace of the error message, if an error occurs. Free form text redacted                                                                          | The stack trace will be helpful for individual debugging purposes and is necessary for us to be able to reproduce issues that may arise.                                                                                                             |
| Error Logs         | The logs of a failed CLI command, if an error occurs. Free form text redacted                                                                              | Error logs will also help us debug and reproduce issues that we see in the CLI.                                                                                                                                                                      |
