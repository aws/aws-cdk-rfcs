...
| Command Parameters           | The optional parameters entereed into the CLI, with any free text redacted                                                   | Some of our features include parameters, like `cdk deploy --watch`. Again, this information is critical to determine fetaure usage and for us to make data-driven decisions.                                                                                                                                    |
...
| Dependencies                 | Relevant AWS dependencies and their versions                                                                                 | We plan to track dependencies that might affect the CLI result, like `aws-cdk-lib`, `jsii`, `projen`, etc..                                                                                                                                                                                                     |
